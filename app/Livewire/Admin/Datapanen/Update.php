...
use App\Models\DataEstimasiPanen;
...
class Update extends Component
{
    ...
    {
        $this->selectedId = $panenId;
        $panen = DataEstimasiPanen::find($panenId);
        ...
        $this->setUpDdata();
        $this->calculate();
        // $this->updating('data_seeding_id', $panen?->data_seeding_id);
    }
    ...
    public function store()
    {
        ...
        DataEstimasiPanen::find($this->selectedId)->update([
