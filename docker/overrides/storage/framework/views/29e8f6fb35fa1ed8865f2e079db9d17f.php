        ...
        <table class="w-full text-left text-sm">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="px-4 py-3 font-medium text-gray-700">Tanggal Penebaran</th>
                    <th class="px-4 py-3 font-medium text-gray-700">SGR(Sampling Growth Rate)</th>
                    <th class="px-4 py-3 font-medium text-gray-700">Target Weight</th>
                    <th class="px-4 py-3 font-medium text-gray-700">Estimasei Hari</th>
                    <th class="px-4 py-3 font-medium text-gray-700">Estimasei Tanggal</th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-4 py-3"><?php echo e($item->dataSeeding->jenis_benih); ?></td>

                        <td class="px-4 py-3"><?php echo e($item->dataSeeding->tanggal_penebaran); ?></td>
                        <td class="px-4 py-3"><?php echo e($item->sgr); ?></td>
                        <td class="px-4 py-3"><?php echo e($item->target_weight); ?></td>
                        <td class="px-4 py-3"><?php echo e($item->estimated_days); ?></td>
                        <td class="px-4 py-3"><?php echo e($item->estimated_harvest_date); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['name' => 'create-panen','class' => 'md:w-1/2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'create-panen','class' => 'md:w-1/2']); ?>
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('admin.datapanen.create', []);
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal8cc9d3143946b992b324617832699c5f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8cc9d3143946b992b324617832699c5f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['wire:show' => 'showUpdate','name' => 'update-panen','class' => 'md:w-1/2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal8cc9d3143946b992b324617832699c5f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8cc9d3143946b992b324617832699c5f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['name' => 'delete-panen','class' => 'min-w-[22rem]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'delete-panen','class' => 'min-w-[22rem]']); ?>
        <div class="space-y-6">
            <div>
...
<?php unset($__componentOriginal8cc9d3143946b992b324617832699c5f); ?>
<?php endif; ?>
</div><?php /**PATH /var/www/html/resources/views/livewire/admin/datapanen/index.blade.php ENDPATH**/ ?>