<div class="space-y-6 mt-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-1 items-center">
        ...
        <div>
            <a href="<?php echo e(route('kolam.create')); ?>" wire:navigate
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-4 py-3"><?php echo e($item->nama_kolam); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['name' => 'delete-kolam','class' => 'min-w-[22rem]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'delete-kolam','class' => 'min-w-[22rem]']); ?>
        <div class="space-y-6">
            <div>
...
<?php endif; ?>
</div><?php /**PATH /var/www/html/resources/views/livewire/admin/datakolam/index.blade.php ENDPATH**/ ?>