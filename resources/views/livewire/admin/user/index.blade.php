<div class="space-y-6 mt-10">
    ...
    <flux:modal name="create-user" class="md:w-1/2">
        <livewire:admin.user.create wire:key="create-form" />
    </flux:modal>
    {{-- @if ($showUpdate) --}}
    <flux:modal wire:show="showUpdate" name="update-user" class="md:w-1/2">
        <livewire:admin.user.update wire:key="update-form-{{ $selectedId }}" :userId="$selectedId" />
    </flux:modal>
