<div class="space-y-6 mt-10">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                @forelse ($data as $index => $item)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-4 py-3">{{ $item->dataSeeding->jenis_benih }}</td>

                        <td class="px-4 py-3">{{ $item->dataSeeding->tanggal_penebaran }}</td>
                        <td class="px-4 py-3">{{ $item->sgr }}</td>
                        <td class="px-4 py-3">{{ $item->target_weight }}</td>
                        <td class="px-4 py-3">{{ $item->estimated_days }}</td>
    ...
    <flux:modal name="create-panen" class="md:w-1/2">
        <livewire:admin.datapanen.create wire:key="create-form" />
    </flux:modal>
    {{-- @if ($showUpdate) --}}
